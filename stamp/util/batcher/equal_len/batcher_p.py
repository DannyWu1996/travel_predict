...
class batcher(object):
    ...
    def next_batch(self):
        ...
        # find the list in current idx length batch.
        ...
        for sample in samplelist:
            ...
            self.out_idxes.append([sample.click_items])
        # print("out:{}".format(self.out_idxes))
        #  here the input is a list of both  in_idxes and out_idxes
        rins, lab, rinlens, rmaxlens, rinlens_float32 = batch_all(
            [self.in_idxes,self.out_idxes], self.out_idxes, class_num=self.class_num
        )
        self.idx += 1
        in_idxes = rins[0]
        out_idxes = rins[1]
